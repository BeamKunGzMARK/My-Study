...
class App extends React.Component {
    ...
    async componentDidMount() {
        ...
        const balanceget = await web3.eth.getBalance(lottery.options.address);

        const balancegetting = web3.utils.fromWei(balanceget, "ether");
        const balanceupper = balancegetting / 0.1;
        const balance = (balancegetting - balanceupper * 0.00133865).toFixed(5);
    ...
    render() {
        return (
            <div class="supercenter">
                <h2>
                    Lottery Contract |{" "}
                    <span style={{ color: "#03CC62" }}>Bitkub</span> Chain
                </h2>
                <p>
                ...
                <form onSubmit={this.onSubmit} class="margintopunder">
